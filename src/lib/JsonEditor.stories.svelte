...
let media_data = {}
// source : https://pmk65.github.io/jedemov2/dist/demo.html
let big_schema = {
...
<Story name="Image in Base64">
  <JsonEditor  bind:data={media_data} schema={media_schema}></JsonEditor>
   {JSON.stringify(media_data)}

</Story>


<Story name="Very complex form">
  <JsonEditor   schema={big_schema}></JsonEditor>
</Story>

<Story name="Object of object">
